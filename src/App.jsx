...
function AppContent() {
  ...
  // Countdown to end of December of the current year
  const currentYear = new Date().getFullYear();
  const countdownTargetDate = new Date(currentYear, 11, 31, 23, 59, 59); // December is month 11 (0-indexed)
...
احجز الآن
      ...
      <main className="flex-grow">
        <HeroSection />
        <ServicesSection />
        <GalleryWithFallback tag="neuro-arabic" />
        <ConditionsSection />
        <TestimonialsSection />
        <FaqSection />
        <ContactSection />
